...
export default async function Page() {
    ...
    return <>
        <h1 className='text-3xl text-center mb-8 text-gray-800 font-bold'>Translations</h1>
        <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xxl:grid-cols-4">
